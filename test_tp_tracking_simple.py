"""
Test du système de TP Tracking - Version simplifiée
...
# Import uniquement de la fonction d'analyse
from geckoterminal_scanner_v2 import analyser_alerte_suivante
...
try:
    ...
    print("\n✅ TEST 1 OK - NOUVEAUX_NIVEAUX attendu")
...
try:
    ...
    print("\n✅ TEST 3 OK - SECURISER_HOLD attendu")
except Exception as e:
...
try:
    ...
    print("\n✅ TEST 4 OK - MAINTENIR_POSITION_INITIALE attendu")
except Exception as e:
